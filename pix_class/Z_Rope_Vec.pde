...
* ROPE is not add before Vec, because is too long, and little to much to have something like
* that RopeVec4() or ROVec3() and there is no confusion with PVector !
*/
/**
Vec Master
