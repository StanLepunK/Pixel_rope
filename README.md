...
pix.change_red			(int new_component_color, int target_color_component, boolean use_new_color) ;
pix.change_green		(int new_component_color, int target_color_component, boolean use_new_color) ;
pix.change_blue			(int new_component_color, int target_color_component, boolean use_new_color) ;

pix.change_hue			(int new_component_color, int target_color_component, boolean use_new_color) ;
pix.change_saturation	(int new_component_color, int target_color_component, boolean use_new_color) ;
pix.change_brightness	(int new_component_color, int target_color_component, boolean use_new_color) ;

pix.change_alpha	(int new_component_color, int target_color_component, boolean use_new_color) ;

// change color in range of color
---------------------------------
int min_range & int max_range is the target color range must be change by a specific color.
pix.change_red			(int new_component_color, int min_range, int max_range, boolean use_new_color) ;
pix.change_green		(int new_component_color, int min_range, int max_range, boolean use_new_color) ;
pix.change_blue			(int new_component_color, int min_range, int max_rang, boolean use_new_color) ;

pix.change_hue			(int new_component_color, int min_range, int max_range, boolean use_new_color) ;
pix.change_saturation	(int new_component_color, int min_range, int max_range, boolean use_new_color) ;
pix.change_brightness	(int new_component_color, int min_range, int max_range, boolean use_new_color) ;

pix.change_alpha	(int new_component_color, int min_range, int max_range, boolean use_new_color) ;
...
Beat
--
beat(int n) n give the size of the beat
